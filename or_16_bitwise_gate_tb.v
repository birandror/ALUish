...
module or_16_bitwise_gate_tb;
    reg [15:0] in_0;
    reg [15:0] in_1;
    wire [15:0] out;

    or_16_bitwise_gate UUT(in_0, in_1, out);

    initial begin
        $dumpfile("or_16_bitwise_gate_tb.vcd");
        $dumpvars(0, or_16_bitwise_gate_tb);
        ...
        $display("or_16_bitwise_gate tested.");
        $finish;
    end
